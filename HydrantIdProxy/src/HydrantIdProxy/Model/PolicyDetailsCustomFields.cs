...
namespace Keyfactor.HydrantId.Model
{
    ...
    /// </summary>
    [DataContract]
    public class PolicyDetailsCustomFields : IEquatable<PolicyDetailsCustomFields>, IValidatableObject, IPolicyDetailsCustomFields
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="PolicyDetailsCustomFields" /> class.
        /// </summary>
        ...
        public PolicyDetailsCustomFields(string tag = default, string label = default, bool? required = default,
        ...
        public bool Equals(PolicyDetailsCustomFields input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyDetailsCustomFields {\n");
        ...
        {
            return Equals(input as PolicyDetailsCustomFields);
        }
