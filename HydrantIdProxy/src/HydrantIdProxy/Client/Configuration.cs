...
namespace Keyfactor.HydrantId.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://acm-stage.hydrantid.com/api/v2";
        ...
        public Configuration(
            ...
            string basePath = "https://acm-stage.hydrantid.com/api/v2") : this()
        {
        ...
        public virtual ApiClient ApiClient
        {
            get
            {
                if (_apiClient == null) _apiClient = GetCreateApiClient();
                return _apiClient;
            }
        }
        ...
        /// <returns></returns>
        public void GetAddDefaultHeader(string key, string value)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ApiClient GetCreateApiClient()
        {
        ...
        /// </summary>
        public static string GetToDebugReport()
        {
        ...
        /// <returns></returns>
        public void GetAddApiKey(string key, string value)
        {
            ApiKey[key] = value;
        }
        ...
        /// <param name="key">Api Key name.</param>
        /// <param name="value">Api Key value.</param>
        public void GetAddApiKeyPrefix(string key, string value)
        {
